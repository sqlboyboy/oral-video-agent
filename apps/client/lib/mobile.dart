            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: _WorkbenchPageState.purpleLine.withValues(
                        alpha: 0.4,
                      ),
                      blurRadius: 30,
                    ),
  ...
  Widget _mobileWorkbenchScaffold() {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: IndexedStack(index: mobileNavigationIndex, children: pages),
          ),
          if (message.isNotEmpty)
            Padding(
            ...
            child: Column(
              children: [
                DropdownButtonFormField<String>(
                  ...
                  items: const ['同款口播', '精简有力', '情绪感染', '专业可信', '种草转化']
                      .map(
                        (style) =>
